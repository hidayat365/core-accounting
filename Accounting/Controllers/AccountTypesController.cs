...
namespace Accounting.Controllers
{
    public class AccountTypesController : Controller
    {
        ...
        public AccountTypesController(AccountingDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,CreatedBy,CreatedOn,ModifiedBy,ModifiedOn")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,CreatedBy,CreatedOn,ModifiedBy,ModifiedOn")] AccountType accountType)
        {
